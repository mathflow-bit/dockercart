...
class Document {
	...
	/**
	 * Add hreflang link for multilanguage SEO
	 * 
	 * @param string $href URL for this language version
	 * @param string $hreflang Language code (e.g., 'en-GB', 'uk-UA', 'x-default')
	 */
	public function addHreflang($href, $hreflang) {
		$this->links[$href . '_' . $hreflang] = array(
			'href' => $href,
			'rel'  => 'alternate',
			'hreflang' => $hreflang
		);
