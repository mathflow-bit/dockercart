...
$_['entry_messenger_fab_status'] = 'Віджет месенджерів';
$_['help_messenger_fab_status']  = 'Показувати плаваючу кнопку в правому нижньому кутку на всіх сторінках. При кліку відображається список месенджерів. Увімкнено за замовчуванням.';
