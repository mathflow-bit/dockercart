...
$_['help_redirect_standard']  = 'Automatically redirect users from the standard OpenCart checkout (checkout/checkout) to DockerCart Checkout';

$_['entry_show_progress']   = 'Show Progress Bar';
$_['help_show_progress']    = 'Display a visual progress indicator at the top of the checkout';

$_['entry_geo_detect']      = 'Auto-detect Location';
$_['help_geo_detect']       = 'Automatically detect customer city/region based on IP address';
...
$_['help_custom_css']       = 'Add custom CSS styles to customize the checkout appearance';

$_['entry_custom_js']       = 'Custom JavaScript';
$_['help_custom_js']        = 'Add custom JavaScript code (ES6+) for additional functionality';

$_['entry_journal3_compat'] = 'Journal 3 Compatibility';
$_['help_journal3_compat']  = 'Enable special styling adjustments for Journal 3 theme';
...
$_['help_required_fields']    = 'Configure which fields are required during checkout';

// Blocks
$_['text_blocks_title']       = 'Manage Checkout Blocks';
$_['text_blocks_info']        = 'Drag and drop to reorder checkout blocks. Click Configure to manage fields in each block.';
...
$_['help_cache_ttl']          = 'Cache lifetime in seconds (0 = no cache, useful for development). Max: 86400';
...
$_['text_method_overrides']   = 'Shipping & Payment Method Name/Description Overrides';
$_['text_method_overrides_help'] = 'Enable and customize names and descriptions for specific shipping and payment methods. Leave fields empty to use default values.';
...
$_['text_no_methods_available'] = 'No methods available. Please ensure shipping/payment extensions are installed and enabled.';
$_['help_method_overrides']   = 'Enable override for a specific method and enter custom title/description. If override is not enabled, the original method name and description will be used.';
...
$_['text_modal_instructions'] = 'Drag fields to reorder • Toggle switches to show/hide or set as required';
...
// JS/UX messages
$_['error_remove_non_empty_row'] = 'Cannot remove a non-empty row. Remove all fields first.';
