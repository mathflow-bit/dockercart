...
$_['error_license_invalid'] = 'Проверка лицензионного ключа отключена в GPL-версии';
...
$_['help_public_key'] = 'В GPL-версии проверка по публичному ключу не используется';
...
$_['text_comment_placeholder'] = 'Напишите примечание к заказу, например пожелания по доставке.';
